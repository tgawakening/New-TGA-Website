...
export const freeWarriorApplicationSchema = z.object({
  ...
  whatDrawsYou: z.string().trim().min(10, "Please share what draws you to this course."),
  howItBenefits: z.string().trim().min(10, "Please explain how this course will benefit you."),
  mostInterestingTopic: z.string().trim().min(2, "Please select or write a topic."),
  whyThisTopic: z.string().trim().min(5, "Please explain why this topic matters to you."),
  canAttendRegularly: z.string().trim().min(2, "Please tell us about your commitment."),
  attendedOrientation: z.boolean(),
  reasonForWaiver: z.string().trim().min(10, "Please explain your fee waiver need."),
